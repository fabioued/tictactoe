...
class GameController extends Controller
{
    public function board(Request $request, $id){
        ...
        $opponentId     = $user->id == $players[0]->player_id ? $players[1]->player_id : $players[0]->player_id;
        ...
        return view('board',compact('user','id','nextTurn','locations','playerType','opponentType','opponentId'));
    }
    ...
    public function gameOver(Request $request, $id){
        ...
        event(new GameOver($id, $user->id, $request->get('result'), $location, $turn->type, $user->score));
